...
create table if not exists public.merchant_brand_settings (
  ...
  social_font_family text not null default 'Sora' check (social_font_family in ('Sora', 'Inter', 'DM Sans', 'Manrope', 'Montserrat', 'Poppins', 'Raleway', 'Work Sans', 'Playfair Display', 'Cormorant Garamond', 'Libre Baskerville', 'Lora', 'Merriweather', 'Georgia', 'Bebas Neue', 'Oswald', 'Anton', 'Caveat', 'Dancing Script', 'Pacifico', 'Trebuchet MS', 'Helvetica Neue')),
  social_template_style text not null default 'editorial' check (social_template_style in ('editorial', 'artisan', 'impact')),
...
begin
  for policy_record in
    ...
    and tablename in ('merchants', 'reviews', 'generated_replies', 'google_connections', 'instagram_connections', 'gmail_connections', 'hans_recommendations', 'notifications', 'review_insights', 'social_post_ideas', 'social_posts', 'social_recommendation_usages', 'social_automation_weekly_runs', 'design_templates', 'media_assets', 'merchant_brand_settings', 'merchant_automation_settings', 'generated_visuals')
  loop
    execute format(
