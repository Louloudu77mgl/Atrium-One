...
select
  ...
  '[]'::jsonb,
  '["Réponses de secours plus courtes, naturelles et adaptées aux avis positifs, mitigés et négatifs.","Prise en compte des sujets fréquents comme l’attente, le rendez-vous, le tarif ou la livraison."]'::jsonb,
