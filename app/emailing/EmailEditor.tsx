...
export function EmailEditor({ content, onChange, merchant, sampleSubscriber }: { content: EmailCampaignContent; onChange: (content: EmailCampaignContent) => void; merchant: MerchantRow | null; sampleSubscriber?: EmailSubscriberProfile }) {
  ...
  return (
    <div className="grid gap-5 xl:grid-cols-[360px_minmax(0,1fr)]">
      <div className={`${surfaceStyles.subtle} space-y-4 p-4`}>
        <div><div className={typographyStyles.h3}>Contenu</div><p className={`${typographyStyles.caption} mt-1`}>Tout reste modifiable. Hans a simplement préparé la première version.</p></div>
