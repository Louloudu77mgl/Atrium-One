        ...
        <div className="space-y-2">
          {items.map((item) => (
            <button
              ...
              className="flex w-full items-start gap-3 rounded-[20px] border border-[#EBE6DF] bg-[#F9F7F4] px-3 py-3 text-left transition hover:border-[#6E4DE0] hover:bg-[#FBF8FF]"
            >
