...
export function AutomationTemplates({
  ...
  return (
    <section className="rounded-[24px] border border-[#EBE6DF] bg-white p-6 shadow-[0_8px_24px_rgba(23,19,31,0.05)]">
      <div className="text-[11px] font-bold uppercase tracking-[0.08em] text-[#9A96A1]">Modèles prêts à l’emploi</div>
      <h2 className="mt-2 text-[22px] font-extrabold text-[#17131F]">Chargez un flow complet dans le canvas</h2>
