        ...
        <main className={appShellStyles.content}>
          <div className={`${appShellStyles.width} min-h-[70vh] place-content-center`}>
            <section className={`${surfaceStyles.section} mx-auto max-w-2xl p-8 text-center sm:p-12`}>
              ...
              <h1 className={`${typographyStyles.h1} mt-2`}>Bientôt</h1>
              <p className="mx-auto mt-4 max-w-lg text-sm font-medium leading-6 text-[#6B617F]">Le module SMS sera bientôt disponible. En attendant, vos campagnes e-mail restent accessibles avec Hans.</p>
