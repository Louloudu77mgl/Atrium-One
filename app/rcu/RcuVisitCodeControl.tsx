  ...
  return (
    <div className="mt-4 rounded-[18px] border border-amber-200 bg-amber-50 p-4">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div><div className="text-xs font-black uppercase tracking-[0.1em] text-amber-700">Code comptoir actif</div><div className="mt-1 font-mono text-3xl font-black tracking-[0.25em] text-amber-950">{currentCode}</div></div>
        <div className="text-xs font-semibold leading-5 text-amber-800 sm:max-w-[230px]">À communiquer uniquement au client présent. Modifiable plusieurs fois par jour.</div>
      </div>
