...
export function PageContentSkeleton({ variant = "dashboard" }: { variant?: SkeletonPageVariant }) {
  ...
  return (
    <div className="ao-page-width ao-stack-6" aria-busy="true" aria-label="Chargement du contenu">
