...
- La route charge la charte et six photos maximum de la médiathèque du commerçant en parallèle. Sans photo, le générateur d’images existant peut créer un hero horizontal avant composition. Aucun scraping, aucun appel IA au chargement du dashboard. Délais bornés à 65 secondes pour chaque appel IA, route limitée à 180 secondes.
